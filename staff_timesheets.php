...
if (! $isMariaDB && isset($supportsAnyValue) && $supportsAnyValue) {
    ...
    'ANY_VALUE(' . db_prefix() . 'taskstimers.tags) as tags',  // <- Your direct `tags` field
...
// Old tag query using tbltaggables:
...
// New direct field from tbltaskstimers:
db_prefix() . 'taskstimers.tags as tags',
