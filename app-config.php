...
*
*/
define('APP_BASE_URL', 'https://devdesk.omnilogicsolutions.com/');
...
*/
define('APP_ENC_KEY', '22bd391e8e170c4d871991cec5bc5694');
 ...
 */
define('APP_DB_USERNAME', 'innsa892_devdesk');

/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', ')Z2q;yGNWcOr');

/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'innsa892_devdesk');
